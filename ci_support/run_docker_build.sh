...
export DOCKER_ENVS_FILE=".docker.envs"
# make sure that the .docker.envs file exists. it is ok if it is empty
touch $DOCKER_ENVS_FILE
# assume all command line arguments are environmental variables
for var in "$@"
do
    echo "$var" >> $DOCKER_ENVS_FILE
done

# for debugging:
echo "Docker environmental variable file"
cat $DOCKER_ENVS_FILE

FEEDSTOCK_ROOT=$(cd "$(dirname "$0")/.."; pwd;)
RECIPE_ROOT=$FEEDSTOCK_ROOT/recipe

# how do I set UPLOAD_OWNER programmatically?
UPLOAD_OWNER="scikit-xray"
